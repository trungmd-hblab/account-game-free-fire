...
const useClientConfigStore = create((set) => ({
  clientConfig: {
    atmRate: 1,
    cardRate: 1,
    logoUrl: "https://api.hungakirarandom.vn/uploads/3%20(11).gif",
    bannerUrl: "https://api.hungakirarandom.vn/uploads/banner%20shop%20hungakirarandom_vn.png",
    footerUrl: "",
    zaloUrl: "https://zalo.me/g/pnhtqf448",
