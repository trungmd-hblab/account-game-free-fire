    ...
    <section className="screen bg-[#1c1b1b] mt-8" id="footer" >
      <Container className='flex flex-col lg:flex-row justify-between gap-10 text-white p-6 md:p-10 ' style={{ maxWidth: '1536px' }}>
        <Box className='flex-[2]'>
          <Text size='sm' className='mb-2' fw={600} classNames='uppercase'>Hungakirashopff.com</Text>
          <Box className='flex flex-col gap-2 '>
            <Text className='text-sm'>Hungakirashopff.com - Acc ngon giá rẻ, không đâu rẻ hơn</Text>
            <Text className='text-sm'>Là điểm đến hoàn hảo cho bạn! hungakirashopff chuyên cung cấp các tài khoản Free Fire với nhiều mức giá, đầy đủ kiểu có hể sỡ hữu ngay một tài khoản FreeFire.</Text>
          </Box>
        </Box>
