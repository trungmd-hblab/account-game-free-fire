...
import BlindBagForm from "../BlindBagForm/BlindBagForm";

function BlindBagTable(props) {
    const {
        columns,
        data,
        limitView,
    ...
    return (
        <>
            ...
            <Modal
                ...
                title="Xác nhận xoá túi mù"
                size={380}
                centered
            >
                <Alert title="Cảnh báo" color="red">
                    Bạn có chắc chắn muốn xoá túi mù này?
                </Alert>
